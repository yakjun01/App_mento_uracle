...
public class SampleActivity2 extends AbstractActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int layout = Utils.getDynamicID(thisObj,"layout","sample2");
		...
		int received_param = Utils.getDynamicID(thisObj,"id","received_param");
		EditText result = (EditText)findViewById(received_param);
