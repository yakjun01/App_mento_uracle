...
- (NSDictionary *)writeFileToBase64:(NSString *)filePath contents:(NSString *)contents error:(NSError **)error;
...
- (void)writeFileToBase64:(NSString *)filePath contents:(NSString *)contents handler:(MFileHandlerCompletionBlock)handler;
