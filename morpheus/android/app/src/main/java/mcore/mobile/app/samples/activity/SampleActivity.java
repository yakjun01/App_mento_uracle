...
public class SampleActivity extends AbstractActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int layout = Utils.getDynamicID(thisObj,"layout","sample");
		...
		int comm = Utils.getDynamicID(thisObj,"id","comm");
		// 통신 테스트
		findViewById(comm).setOnClickListener(new OnClickListener() {
		...
		int moveToNativeAct = Utils.getDynamicID(thisObj,"id","moveToNativeAct");
		// 네이티브 화면으로의 이동
		findViewById(moveToNativeAct).setOnClickListener(new OnClickListener() {
		...
		int moveToWeb = Utils.getDynamicID(thisObj,"id","moveToWeb");
		// UI 웹화면으로 이동
		findViewById(moveToWeb).setOnClickListener(new OnClickListener() {
		...
		int back_button = Utils.getDynamicID(thisObj,"id","back_button");
		// 이전 버튼
		findViewById(back_button).setOnClickListener(new OnClickListener() {
...
//		PLog.i(CLASS_TAG, "Abstract onNewIntent()");
	 ...
	 * @param netReqOpt : 네트워크 옵션
	 */
	@Override
	public void responseData(int nDataType, String stTrCode, String otherInfos, String dhRecvData, NetReqOptions netReqOpt) {
		int result_comm = Utils.getDynamicID(thisObj,"id","result_comm");
		EditText result = (EditText)findViewById(result_comm);
