...
public class ImageList2Activity extends AbstractActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_back = findViewById(ID_BACK);
        int id_back = getResources().getIdentifier("mp_select_folder", "string", getPackageName());
        btn_back.setText("< "+getResources().getString(id_back));
        Button btn_set = findViewById(ID_SET);
        if (singleMode){
            btn_set.setText("취소");
        }else{
            btn_set.setText("완료");
...
//		mImageList = (ArrayList<String[]>) mParams.getParam("dir");
        ...
        findViewById(ID_SET).setOnClickListener(view -> setSelectedImage());
...
/*	    System.out.println("calculateInSampleSize: width: " + width);
	...
	private void initID(Context context) {
        ...
        ID_BACK = res.getIdentifier("go_album", "id", context.getPackageName());
	}
...
//			grid.setNumColumns(3);
    ...
    //targetSdk 33 deprecated (OnBackPressedDispatcher 사용)
	/*@Override
